...
export function getCompanySteps(company:CompanyPolicy):ApplicationStep[]{
  ...
  return[
    ...
    {id:3,company:name,journey:"post_death",link_type:"request",title:`고인의 ${name} 계정 처리 요청`,description:"고인의 계정을 삭제하거나 이용을 종료하는 공식 요청 방법을 확인해요.",url:urls.deceased??fallback,required_documents:documents,sort_order:1,notes:company.limitations.join(" ")},
